...
Out of `r details[taxon_ids == '', .N]` rows with seemingly valid
`taxon_ids`, there are up to 17 species listed in any row. Eg.
...
study details dataset, we have `r DT[, .N]` species by study rows.
